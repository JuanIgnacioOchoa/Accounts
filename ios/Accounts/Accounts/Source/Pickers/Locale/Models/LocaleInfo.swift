...
public struct LocaleInfo {
    ...
    public var flag: UIImage? {
        return UIImage(named: "Countries.bundle/Images/\(code)", in: Bundle.main, compatibleWith: nil)
    }
    public var currencyFlag: UIImage? {
        if currencyCode == nil {
            return nil
        }
        return UIImage(named: "Countries.bundle/CurrencyFlag/\(currencyCode!)", in: Bundle.main, compatibleWith: nil)
    }
